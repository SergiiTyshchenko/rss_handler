...
<head>
    ...
    <style>
        ...
        .user.ng-dirty.ng-invalid-required {
            ...
            <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <label class="col-md-2 control-lable" for="reqname">User</label>
                        <div class="col-md-7">
                            <input type="text" ng-model="ctrl.channel.user" id="reqname" class="user form-control input-sm" placeholder="Enter user name" required ng-minlength="3"/>
        ...
        <div class="tablecontainer">
            <table class="table table-hover">
                ...
                <tr ng-repeat="u in ctrl.channels">
                    ...
                    <td><span ng-bind="u.user"></span></td>
